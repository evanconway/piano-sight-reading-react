...
KeyScaleMidiMap.set("Cm", new Map([[3, {midi: 3, pitchClass: "E"}], [4, {midi: 5, pitchClass: "F"}], [5, {midi: 7, pitchClass: "G"}], [6, {midi: 8, pitchClass: "A"}], [7, {midi: 10, pitchClass: "B"}], [1, {midi: 0, pitchClass: "C"}], [2, {midi: 2, pitchClass: "E"}]]));
