...
import { SCORE_ID, SCORE_SCALE_PHONE } from "./defaults";
...
export const renderAbcjs = (measures: Measure[], width: number) => {
    ...
    */
    ...
    console.log("render invoked: ", width);

	/*
    The built in padding for the svg generated by abcjs.renderAbc doesn't squish the svg, it expands it. 
    Since we can't have the abc svg expanding beyond the score, we set left/right padding here to 0, and
    limit the width of it to simulate padding.
    */
    const paddingX = 40;
    ...
    abcjs.renderAbc(SCORE_ID, abcString, {
        ...
        //scale: 0.9, // bugged when less than 1??
    });
